...
from .static_funcs import create_experiment_folder,create_logger
import re
import time
...
class DLLearnerBinder:
    ...
    def fit_from_iterable(self, dataset: List = None, max_runtime=None) -> List[Dict]:
        ...
        if max_runtime:
            ...
            self.max_runtime = max_runtime
        return [self.fit(pos=i['positive_examples'], neg=i['negative_examples'], max_runtime=self.max_runtime).best_hypothesis() for i in dataset]
